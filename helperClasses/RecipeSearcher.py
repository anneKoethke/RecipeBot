...
def search_for_recipe(context, update, db, model, details):
    # details.current_recipe = result_data
    search_recipe_details(context, update, db, model, details)
    ...
    if details.current_recipe is None:
        ...
        system_message = modify_recipe_search(context, update, db, model, details, modified_recipe_details)
...
def search_recipe_details(context, update, db, model, details):
...
def modify_recipe_search(context, update, db, model, details, modified_recipe_details):
            ...
            if not details.modify_recipe_found:
                ...
                if key in [recipe_keys.RECIPE_PREPARATION, recipe_keys.RECIPE_ORIGIN, "servings", "duration",
                    ...
                    if result_data:
                        ...
                        details.modify_recipe_found = False
                        modify_recipe_search(context, update, db, model, details, modified_recipe_details)
